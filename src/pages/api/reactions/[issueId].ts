/* SSR: this route needs a request. `output: 'hybrid'` prerenders by
   default, so every app surface must opt out explicitly — miss one and it
   is baked at build time with no session. */
